...
class PublishersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publisher" do
    assert_difference('Publisher.count') do
      post publishers_url, params: { publisher: { game_id: @publisher.game_id, name: @publisher.name } }
    end
  ...
  test "should update publisher" do
    patch publisher_url(@publisher), params: { publisher: { game_id: @publisher.game_id, name: @publisher.name } }
